...
ID3D12Device* InstancingModel::device_ = nullptr;
ID3D12GraphicsCommandList* InstancingModel::commandList_ = nullptr;
ID3D12RootSignature* InstancingModel::rootSignature_ = nullptr;
ID3D12PipelineState* InstancingModel::pipelineStates_[InstancingModel::BlendMode::kCountBlend] = { nullptr };
//ID3D12PipelineState* Model::pipelineState_ = nullptr;
IDxcBlob* InstancingModel::vs3dBlob_ = nullptr;
IDxcBlob* InstancingModel::ps3dBlob_ = nullptr;
int InstancingModel::modelNumber_ = 0;
InstancingModel::BlendMode InstancingModel::currentBlendMode_ = InstancingModel::BlendMode::kNormal;
const char* InstancingModel::BlendTexts[InstancingModel::BlendMode::kCountBlend] = { "Normal", "Add", "Subtract", "Multiply", "Screen" };

void InstancingModel::StaticInitialize(ID3D12Device* device) {
...
void InstancingModel::LoadAnimation(const std::string& filename) {
...
void InstancingModel::ResetAnimation() {
...
void InstancingModel::PreDraw(ID3D12GraphicsCommandList* commandList) {
...
void InstancingModel::Draw(const Matrix4x4& localMatrix, Camera* camera) {
...
void InstancingModel::Finalize() {

}

//デバッグ時に使用
void InstancingModel::StaticImGuiUpdate() {
...
void InstancingModel::SetMesh(const std::string& objFileName) {
